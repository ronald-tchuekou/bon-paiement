...
import { AddMVTPopup } from '../src/components/dotations_mvt/add_mvt_popup';
...
export default function DotationMvt() {
    ...
    return (
        <ShowAddMvtPupopContext.Provider value={{ show_add_mvt_popup: () => add_popup_ref.current.show() }}>
        ...
        </ShowAddMvtPupopContext.Provider>
    );
}
